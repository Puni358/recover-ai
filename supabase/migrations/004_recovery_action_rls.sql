drop policy if exists "users can insert recovery actions" on recovery_actions;
...
drop policy if exists "users can update recovery actions" on recovery_actions;
